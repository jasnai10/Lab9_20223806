    ...
    <body>
        ...
        <div class='container'>
                    ...
                    <div class="col-lg-3">
                        <select name="tipo" class="form-control">
                            ...
                            <%
                                ...
                                String tipoSeleccionado = request.getParameter("tipo"); // obtener valor seleccionado

                                for (String opcion : opciones) {
                            %>

                            <option value="<%=opcion%>" <%= opcion.equals(tipoSeleccionado) ? "selected" : "" %>><%=opcion%></option>
                            <% } %>
                        </select>
                    </div>
                    <div class="col-lg-5">
            ...
            <table class="table">
                ...
                %>
                <tr>
                    <td colspan="4" class="text-center">No hay resultados para la búsqueda.</td>
                </tr>
                <% } %>
            </table>
        </div>
